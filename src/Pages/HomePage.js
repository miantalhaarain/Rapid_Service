...
//                   gap: 0,
//                   zIndex: 1,
//                   width: "45%", // Decrease the width of the image container
//                   maxHeight: "500px", // Set a maximum height for the image container
//                 }}
//               >
//                 <Button
//                   variant="contained"
  ...
  const serviceData = [
    {
      ...
      description: "Lorem ipsum is a placeholder text commonly used to demonstrate the visual form of a document or a typeface without relying on meaningful content. Lorem ipsum may be used.",
    },
    {
  ...
  return (
    <>
        ...
        >
          ...
          >
            <Grid item xs={12} md={6}>
              ...
              >
                Lorem ipsum is a placeholder text commonly used to demonstrate
                the visual form of a <br/> document or a typeface without relying on
                meaningful content.
              </Typography>
              <Box mt={3} display="flex" flexDirection="column" gap={0.5}>
                <Box display="flex" alignItems="center" gap={2.5}>
      ...
      >
        ...
        >
          Lorem ipsum is a placeholder text commonly used to demonstrate the
          visual form of a <br/>document or a typeface without relying on meaningful
          content. Lorem ipsum may be used.
        </Typography>
      </Box>
      ...
      <Box
        sx={{
          backgroundColor: "#262f69",
          py: 6,
          mt: 4, // Add margin top to create gap between sections
        }}
      >
      ...
      >
        <Container maxWidth="lg">
          ...
          >
            Lorem ipsum is a placeholder text commonly used to demonstrate the
            visual form of a <br/>document or a typeface without relying on
                    ...
                    >
                      <img
                        ...
                        style={{
                          width: "40px",
                          height: "40px",
                          marginBottom: "8px", // Margin bottom to place title below icon
                        }}
                      />
                      <Typography
                        variant="h6"
      ...
      <Box
        sx={{
          backgroundColor: "#d9534f",
          py: 6,
          mt: 0, // Add margin top to create gap between sections
        }}
      >
        <Container maxWidth="lg">
