    ...
    <>
      ...
      >
        <Typography
          variant="h2"
          sx={{
            fontSize: { xs: "26px", sm: "26px", lg: "26px" },
            fontWeight: "700",
            color: "#262f69",
            mb: 2,
          }}
      ...
      {/* <Container sx={{ mt: -5 }} > */}
        ...
        {/* Buttons Code started here */}
        <Container sx={{ mt: -5, ml: 7, margin: 'auto' }}>
  <Box
    sx={{
      display: "flex",
      maxWidth: "91.3%",
      ...
      flexWrap: "wrap",
      margin: 'auto',
      height: '56px' // Set height of buttons
    }}
  >
    {["Fire Safety", "Security", "Health and Safety", "Education"].map(
      (buttonName, index) => (
        <Button
          ...
          sx={{
            ...
            flexGrow: 1, // Allow buttons to grow evenly
            borderTopLeftRadius: index === 0 ? "8px" : "0px", // Rounded left corners for 0 index
            borderBottomLeftRadius: index === 0 ? "8px" : "0px", // Rounded left corners for 0 index
            borderTopRightRadius: index === 3 ? "8px" : "0px", // Rounded right corners for 3rd index
            borderBottomRightRadius: index === 3 ? "8px" : "0px", // Rounded right corners for 3rd index
            height: '56px', // Set height of buttons
            lineHeight: '56px', // Ensure text is vertically centered
            display: 'flex',
            justifyContent: 'center',
            alignItems: 'center',
          }}
              ...
              <Grid item xs={12} md={6}>
                <Box
                  sx={{
                    ...
                    justifyContent: "center",
                    alignItems: "center",
                    mb: -17.6, // Adjust this value as needed to ensure separation from the following section
                  }}
                >
                  <img
                    src="Picture → download-gp-badges.webp.png"
